...
<head>
	...
	<?php } ?>
		...
		<script type="text/javascript" src="dist/opensourcepos.min.js?rel=c1ac850612"></script>
		...
		<div class="topbar">
			<div class="container">
				...
				<div class="navbar-right" style="margin:0">
					...
					<a href="<?php echo site_url('home/logout'); ?>"><?php echo $this->lang->line('login_logout');?></a>
				</div>
